...
function updateProfile(username, updates) {
  ...
  if (result) {
    return {
      success: true,
      message: "ធ្វើបច្ចុប្បន្នភាព Profile ជោគជ័យ",
      user: result,
    };
  }
...
function loadProfile(username) {
  ...
  if (!user) {
    document.body.innerHTML =
      '<div class="container mt-5"><div class="alert alert-danger">រកមិនឃើញអ្នកប្រើប្រាស់</div></div>';
    return;
  }
                ...
                <div class="col-md-3 text-center">
                    ...
                    `
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="messages.html?user=${username}" class="btn btn-outline-secondary btn-sm">
                                <i class="bi bi-chat-fill"></i> ផ្ញើសារ
                            </a>
                        </div>
                    `
                    }
